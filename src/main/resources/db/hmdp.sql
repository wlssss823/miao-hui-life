...
-- ----------------------------
-- Table structure for tb_follow_shop
-- ----------------------------
DROP TABLE IF EXISTS `tb_follow_shop`;
CREATE TABLE `tb_follow_shop`  (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `user_id` bigint(20) UNSIGNED NOT NULL COMMENT '用户 id',
  `shop_id` bigint(20) UNSIGNED NOT NULL COMMENT '店铺 id',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `tb_review`  (
  ...
  `images` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '图片，逗号分隔',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
-- Table structure for tb_notice（消息通知）
-- ----------------------------
DROP TABLE IF EXISTS `tb_notice`;
CREATE TABLE `tb_notice`  (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `user_id` bigint(20) UNSIGNED NOT NULL COMMENT '接收用户 id',
  `type` tinyint(3) UNSIGNED NOT NULL COMMENT '通知类型：1=系统 2=订单 3=店铺上新 4=博客点赞 5=新关注',
